 ...
 */
final class Version20230307163654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation DROP service_midi_id, DROP service_soir_id, CHANGE cutlery_number nb_couverts INT NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE TABLE service_midi (id INT AUTO_INCREMENT NOT NULL, horaire TIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE service_soir (id INT AUTO_INCREMENT NOT NULL, horaire TIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE reservation ADD service_midi_id INT DEFAULT NULL, ADD service_soir_id INT DEFAULT NULL, CHANGE nb_couverts cutlery_number INT NOT NULL');
